...
// For fonts and models on GitHub Pages, respect the base URL
const fontUrl = import.meta.env.BASE_URL + "bebas-neue-v9-latin-regular.woff";
const hamburgerUrl = import.meta.env.BASE_URL + "hamburger.glb";
  ...
  return (
    <group position={position}>
      ...
      <Float floatIntensity={0.25} rotationIntensity={0.25}>
        <Text
          // Use BASE_URL so the font works on GitHub Pages too
          font={import.meta.env.BASE_URL + "bebas-neue-v9-latin-regular.woff"}
          scale={0.5}
          maxWidth={0.25}
          lineHeight={0.75}
          textAlign="right"
...
export function BlockEnd({ position = [0, 0, 0] }) {
  const hamburger = useGLTF(hamburgerUrl); // Load 3D model
  ...
  return (
    <group position={position}>
      <Text
        font={new URL("bebas-neue-v9-latin-regular.woff", import.meta.url).href}
        scale={1}
        position={[0, 2.25, 2]}
      >
        FINISH
